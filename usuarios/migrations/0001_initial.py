    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pk_cedula', models.IntegerField(primary_key=True, serialize=False)),
                ('v_primernombre', models.CharField(max_length=100)),
                ('v_segundonombre', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            name='Cliente',
            fields=[
                ('fk_persona', models.OneToOneField(db_column='fk_persona', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
